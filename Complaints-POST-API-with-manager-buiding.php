    ...
    else
{
  ...
  $sql = "insert into `complaints`(id,building_name,manager_email,tenant_name,tenant_mobile,tenant_email,floor_no,room_no,bed_no,complaint_type,complaint_description,created_date,resolve_date,comments,response,status)
   values('$id','$building_name','$manager_email','$tenant_name','$tenant_mobile','$tenant_email','$floor_no','$room_no','$bed_no','$complaint_type','$complaint_description','$created_date','$resolve_date','$comments','$response','$status')";
