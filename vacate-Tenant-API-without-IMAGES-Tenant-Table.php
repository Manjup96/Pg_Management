...
$get_tenant_Details_sql_query="SELECT `tenant_name`, `tenant_email`, `tenant_mobile`,  `tenant_aadhar_number`, `joining_date` FROM `tenant_registration_manager_email` WHERE tenant_mobile='$tenant_mobile'";
...
// {
//     $sql="DELETE FROM `tenant_registration_without_image` WHERE `tenant_mobile`=$tenant_mobile";
